...
export default async function handler(req: VercelRequest, res: VercelResponse) {
...

    {
      ...
      "masterPrompt": "Un prompt en INGLÉS para la ESCENA DE APERTURA (Opening/Intro Scene) del video musical, optimizado para IAs de video (Runway Gen-3, Sora). PROHIBIDO copiar los ejemplos por defecto o usar siempre el mismo texto genérico. Debe describir un evento narrativo visual concreto y espectacular basado en la letra de la canción para servir como la escena introductoria del video musical. Debe especificar el plano inicial, la acción física, el entorno simbólico, la iluminación dramática, movimientos de cámara lentos y majestuosos, y etiquetas técnicas de alta gama (ej: 'cinematic opening shot, shot on Arri Alexa LF, 35mm anamorphic lens, masterfully color-graded, volumetric light, slow-motion, photo-realistic, hyper-detailed texture') adaptando todo a la historia lírica.",
      "scenes": [
        {
