...
// NEW DGM JSX
const dgmJsx = `// === TEMA DIOSMASGYM (Urbano / Oscuro / Dorado) ===
    if (!isJuan) {
        return (
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center w-full max-w-7xl mx-auto px-4 py-8 md:py-16 gap-8 md:gap-12 animate-fade-in">
                    ...
                    <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                        ...
                        <div className="w-full max-w-lg flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <p className="text-[#c5a059] text-[12px] md:text-[14px] font-black uppercase tracking-[0.5em] mb-6 md:mb-8">{song.artist}</p>
                            ...
                            {embedData?.type === 'spotify' && (
                                <div className="w-full max-w-md mb-4 md:mb-8 rounded-xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.5)] border border-[#c5a059]/20 bg-black/40 p-2 backdrop-blur-md">
                    ...
                    {/* PLATFORMS SECTION */}
                    <div className="w-full max-w-6xl relative z-20 backdrop-blur-xl bg-black/45 p-6 md:p-10 rounded-3xl border border-[#c5a059]/20 shadow-[0_20px_50px_rgba(197,160,89,0.08)] transition-all hover:border-[#c5a059]/30 duration-500 overflow-hidden">
                        <HUDCorners color="#c5a059" />
                        
                        <h3 className="text-[#c5a059] text-[12px] md:text-[14px] font-black uppercase tracking-[0.3em] mb-8 flex items-center justify-center gap-3">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <PlatformButton platform="Sitio Oficial" icon="fas fa-globe" color="#c5a059" url="https://musica.diosmasgym.com/" isJuan={false} />
                        </div>
                    </div>
                    ...
                    <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="flex flex-col gap-6 md:gap-8">
                            ...
                            <div className="w-full h-full backdrop-blur-xl bg-black/45 p-6 md:p-8 rounded-2xl border border-[#c5a059]/15 shadow-[0_15px_35px_rgba(0,0,0,0.4)] text-left relative overflow-hidden group">
                                <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-[#c5a059] to-[#8c6b32]"></div>
                                
                                <div className="flex justify-between items-center mb-6">
                                    <h4 className="text-[#c5a059] text-[10px] md:text-[12px] font-black uppercase tracking-[0.25em] flex items-center gap-2">
                                        <i className="fas fa-shield-halved text-[#c5a059]"></i> ESCUDO DE FE / ALIENTO DIARIO
                                    </h4>
                                    <button 
                                        onClick={() => fetchBibleVerse(false)} 
                                        disabled={loadingVerse}
                                        className="text-[#c5a059] hover:text-white transition-colors p-2 flex items-center justify-center font-bold uppercase tracking-widest disabled:opacity-40"
                                    >
                                ...
                                {loadingVerse ? (
                                    <div className="py-8 flex justify-center items-center">
                                        <div className="w-6 h-6 border-2 border-[#c5a059] border-t-transparent animate-spin rounded-full"></div>
                                    </div>
                                ) : (
                                ...
                                <div className="flex justify-between items-center border-t border-white/5 pt-4 mt-auto">
                                    ...
                                    <a 
                                        href="/" 
                                        className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-[#c5a059] hover:text-white transition-colors flex items-center gap-1.5"
                                    >
                        ...
                        <div className="flex flex-col gap-6 md:gap-8">
                            ...
                            <div className="w-full backdrop-blur-xl bg-black/45 p-6 md:p-8 rounded-2xl border border-white/5 shadow-[0_15px_30px_rgba(0,0,0,0.3)]">
                                <h3 className="text-[10px] md:text-[12px] font-black uppercase tracking-[0.3em] text-[#c5a059] mb-6 text-left flex items-center gap-2">
                                ...
                                <div className="flex flex-wrap gap-4 justify-center mb-6">
                                    ...
                                    <button 
                                        ...
                                        className="w-12 h-12 rounded-full flex items-center justify-center bg-white/5 border border-white/10 hover:bg-[#c5a059] hover:text-black transition-all text-sm md:text-base"
                                        title="Código QR"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className="w-12 h-12 rounded-full flex items-center justify-center bg-white/5 border border-white/10 hover:bg-[#c5a059] hover:text-black transition-all relative text-sm md:text-base"
                                        title="Copiar enlace"
                                    >
                            ...
                            <div className="w-full backdrop-blur-xl bg-black/45 p-6 md:p-8 rounded-2xl border border-white/5 shadow-[0_15px_30px_rgba(0,0,0,0.3)] flex flex-col items-center justify-center text-center">
                                <h3 className="text-[10px] md:text-[12px] font-black uppercase tracking-[0.3em] text-[#c5a059] mb-4">No te pierdas de nada</h3>
                                <button 
                                    onClick={subscribe}
                                    className={\`flex items-center gap-3 px-8 py-4 rounded-full border transition-all group \${isSubscribed ? 'bg-green-500/10 border-green-500/30' : 'bg-white/5 border-white/10 hover:border-[#c5a059] hover:bg-[#c5a059]/10'}\`}
                                >
                                    <i className={\`fas \${isSubscribed ? 'fa-check-circle text-green-500 text-lg' : 'fa-bell text-[#c5a059] group-hover:animate-bounce text-lg'}\`}></i>
                            ...
                            {relatedSongs.length > 0 && (
                                <div className="w-full backdrop-blur-xl bg-black/45 p-6 md:p-8 rounded-2xl border border-white/5 shadow-[0_15px_30px_rgba(0,0,0,0.3)]">
                                    <h3 className="text-[10px] md:text-[12px] font-black uppercase tracking-[0.3em] text-[#c5a059] mb-6 flex items-center gap-3 text-left">
                                    ...
                                    <div className="space-y-3">
                                        {relatedSongs.map((track, i) => (
                                            ...
                                            >
                                                ...
                                                <i className="fas fa-chevron-right text-[12px] text-white/20 group-hover:text-[#c5a059] transition-colors"></i>
                                            </button>
                                        ))}
                                    </div>
                                </div>
                    ...
                    {otherReleases.length > 0 && (
                        <div className="w-full max-w-6xl backdrop-blur-xl bg-black/45 p-6 md:p-10 rounded-3xl border border-white/5 shadow-[0_15px_30px_rgba(0,0,0,0.3)] text-center">
                            <h4 className="text-[#c5a059] text-[12px] md:text-[14px] font-black uppercase tracking-[0.3em] mb-8 flex items-center justify-center gap-3">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                                {otherReleases.map((other, idx) => (
                                    <button 
                                        ...
                                        className="w-full flex flex-col items-center p-3 md:p-4 rounded-2xl bg-white/[0.02] border border-white/5 hover:bg-white/5 hover:border-[#c5a059]/30 transition-all duration-300 group"
                                    >
                                        ...
                                        <h5 className="text-[12px] md:text-[14px] font-bold text-white leading-snug group-hover:text-[#c5a059] transition-colors line-clamp-1">{other.name}</h5>
...
const juanJsx = \`
    ...
    return (
        <div className="min-h-screen bg-[#110e0c] text-[#e8dcc5] font-['Outfit'] flex flex-col relative overflow-hidden">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center w-full max-w-7xl mx-auto px-4 py-8 md:py-16 gap-8 md:gap-12 animate-fade-in">
                ...
                <div className="w-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                    <div className="w-full max-w-sm shrink-0 transition-transform duration-500 group relative">
                        ...
                        <div className="relative w-64 h-64 md:w-96 md:h-96 mx-auto overflow-hidden rounded-[12px] border-2 border-[#8B5A2B]/40 shadow-[0_20px_50px_rgba(20,10,5,0.8)] transition-transform duration-500 group-hover:scale-[1.02]">
                            <img 
                                src={song.cover} 
                                alt={song.name} 
                    ...
                    <div className="w-full max-w-lg flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        {embedData?.type === 'spotify' && (
                            <div className="w-full max-w-md mb-4 md:mb-8 rounded-xl overflow-hidden shadow-[0_10px_25px_rgba(0,0,0,0.6)] border border-[#8B5A2B]/30 bg-[#2a221f]/60 p-2 backdrop-blur-md">
                                <div className="flex items-center justify-between mb-3 px-2 pt-2">
                ...
                {/* PLATFORMS SECTION */}
                <div className="w-full max-w-6xl relative z-20 backdrop-blur-xl bg-[#2a221f]/50 p-6 md:p-10 rounded-2xl border border-[#8B5A2B]/20 shadow-[0_15px_35px_rgba(0,0,0,0.5)] transition-all hover:border-[#8B5A2B]/40 duration-500">
                ...
                <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col gap-6 md:gap-8">
                        ...
                        {/* Palabra de Aliento Card */}
                        <div className="w-full h-full backdrop-blur-xl bg-[#2a221f]/50 p-6 md:p-8 rounded-2xl border border-[#8B5A2B]/20 shadow-[0_15px_35px_rgba(0,0,0,0.4)] text-left relative overflow-hidden group">
                            ...
                            <div className="flex justify-between items-center border-t border-[#8B5A2B]/20 pt-4 mt-auto">
                    ...
                    <div className="flex flex-col gap-6 md:gap-8">
                        {/* Compartir & Redes */}
                        <div className="w-full backdrop-blur-xl bg-[#2a221f]/50 p-6 md:p-8 rounded-2xl border border-[#8B5A2B]/20 shadow-[0_15px_30px_rgba(0,0,0,0.3)]">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center mb-6">
                                ...
                                <button 
                                    onClick={() => setShowQrModal(true)}
                                    className="w-12 h-12 rounded-lg flex items-center justify-center bg-[#8B5A2B]/10 border border-[#8B5A2B]/30 hover:bg-[#8B5A2B] hover:text-white transition-all text-sm md:text-base"
                                    title="Código QR"
                                >
                                    <i className="fas fa-qrcode"></i>
                                </button>
                                <button 
                                    onClick={copyToClipboard}
                                    className="w-12 h-12 rounded-lg flex items-center justify-center bg-[#8B5A2B]/10 border border-[#8B5A2B]/30 hover:bg-[#8B5A2B] hover:text-white transition-all relative text-sm md:text-base"
                                    title="Copiar enlace"
                                >
                                    <i className={\`fas \${copied ? 'fa-check' : 'fa-link'}\`}></i>
                                    {copied && (
                                        <span className="absolute -top-12 bg-black text-[#c89d53] text-[10px] px-3 py-1.5 rounded border border-[#8B5A2B] animate-bounce whitespace-nowrap z-50">
                                            ¡Copiado!
                                        </span>
                                    )}
                                </button>
                        ...
                        {/* Avísame Card */}
                        <div className="w-full backdrop-blur-xl bg-[#2a221f]/50 p-6 md:p-8 rounded-2xl border border-[#8B5A2B]/20 shadow-[0_15px_30px_rgba(0,0,0,0.3)] flex flex-col items-center justify-center text-center">
                            <h3 className="text-[10px] md:text-[12px] font-bold uppercase tracking-[0.2em] text-[#c89d53] mb-4 font-mono">Próximos Estrenos</h3>
                            <button 
                                onClick={subscribe}
                                className={\`flex items-center gap-3 px-8 py-4 rounded-lg border transition-all group \${isSubscribed ? 'bg-green-500/10 border-green-500/30' : 'bg-[#8B5A2B]/10 border-[#8B5A2B]/30 hover:bg-[#8B5A2B]/20'}\`}
                            >
                                ...
                                <div className="space-y-3">
                                    {relatedSongs.map((track, i) => (
                                        <button 
                                            key={i} 
                                            onClick={() => navigate(\`/link/\${track.id}\`)}
                                            className="w-full flex items-center justify-between p-4 bg-[#1a1411]/50 rounded-lg border border-[#8B5A2B]/10 hover:border-[#8B5A2B]/30 transition-all group"
                                        >
                                            <div className="flex items-center gap-4">
                ...
                {/* OTROS LANZAMIENTOS (FULL WIDTH GRID) */}
                {otherReleases.length > 0 && (
                    <div className="w-full max-w-6xl backdrop-blur-xl bg-[#2a221f]/50 p-6 md:p-10 rounded-2xl border border-[#8B5A2B]/20 shadow-[0_15px_30px_rgba(0,0,0,0.3)] text-center">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                            {otherReleases.map((other, idx) => (
                                <button 
                                    key={idx}
                                    onClick={() => navigate(\`/link/\${other.id}\`)}
                                    className="w-full flex flex-col items-center p-3 md:p-4 rounded-xl bg-[#1a1411]/50 border border-[#8B5A2B]/10 hover:border-[#8B5A2B]/30 transition-all duration-300 group"
                                >
            ...
            {/* Footer */}
            <div className="mt-8 text-center w-full border-t border-[#8B5A2B]/20 pb-8 pt-8 relative z-20 max-w-7xl mx-auto px-4">
                <h3 className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] text-[#c89d53]/70 mb-6 font-mono">Sígueme</h3>
                <div className="flex justify-center gap-6">
                    <a href="https://instagram.com/juan614oficial" target="_blank" rel="noreferrer" className="w-12 h-12 md:w-14 md:h-14 rounded-lg bg-[#8B5A2B]/10 border border-[#8B5A2B]/20 flex items-center justify-center hover:bg-[#8B5A2B]/30 transition-all duration-300"><i className="fab fa-instagram text-xl md:text-2xl text-[#c89d53]"></i></a>
                    <a href="https://tiktok.com/@juan614oficial" target="_blank" rel="noreferrer" className="w-12 h-12 md:w-14 md:h-14 rounded-lg bg-[#8B5A2B]/10 border border-[#8B5A2B]/20 flex items-center justify-center hover:bg-[#8B5A2B]/30 transition-all duration-300"><i className="fab fa-tiktok text-xl md:text-2xl text-[#c89d53]"></i></a>
                </div>
...
const finalContent = beforeDgm + dgmJsx + juanJsx;
