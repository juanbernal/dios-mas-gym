    ...
    <div className="flex flex-col md:flex-row min-h-screen md:h-screen bg-[#030305] text-white">
      ...
      <aside className="flex-1 md:flex-none md:w-[420px] bg-[#0a0a0f] border-l border-white/5 p-8 custom-scrollbar overflow-y-auto">
        ...
        <div className="flex items-center gap-3 mb-10">
            ...
            <h1 className="text-xl font-black italic tracking-tighter uppercase">Lyric Studio <span className="text-[9px] not-italic text-zinc-600 font-bold ml-1">Modern FX / V2.1</span></h1>
        </div>
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                >
                    {isGeneratingStyle ? (
                        ...
                        <><i className="fas fa-wand-magic-sparkles"></i> Diseño Mágico IA v2.1</>
                    )}
                </button>
            </div>
