...
const ArmaduraPromo: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-[#030406] border-y border-[#b91c1c]/10 relative overflow-hidden">
      {/* Background styling */}
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-[0.03] bg-[linear-gradient(45deg,#b91c1c_1px,transparent_1px),linear-gradient(-45deg,#b91c1c_1px,transparent_1px)] bg-[size:40px_40px] pointer-events-none"></div>
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 border border-[#b91c1c]/20 bg-[#b91c1c]/5 rounded-sm mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-[#b91c1c] shadow-[0_0_10px_#b91c1c] animate-pulse"></span>
              <span className="text-[8px] font-black uppercase tracking-[0.4em] text-[#b91c1c]">Próximamente</span>
            </div>
            
            <h2 className="font-serif text-5xl md:text-7xl leading-none mb-6 text-white drop-shadow-lg">
              La <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d]">Armadura</span>
            </h2>
            ...
            {subscribed ? (
              <div className="bg-[#b91c1c]/10 border border-[#b91c1c]/30 p-6 rounded-sm w-full max-w-md">
                <p className="text-[#b91c1c] text-[10px] font-black uppercase tracking-[0.2em] mb-2 flex items-center gap-2">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                <input 
                  ...
                  required
                  className="flex-1 bg-black/40 border border-white/10 p-4 text-[10px] font-black tracking-[0.2em] outline-none focus:border-[#b91c1c] transition-all rounded-sm uppercase text-white"
                />
                <button 
                  type="submit"
                  className="px-8 py-4 bg-[#b91c1c] text-black font-black uppercase text-[10px] tracking-[0.3em] hover:bg-white hover:scale-105 transition-all shadow-[0_10px_30px_rgba(197,160,89,0.2)] rounded-sm whitespace-nowrap"
                >
                  Avisarme
                </button>
              </form>
          ...
          <div className="w-full md:w-1/2 relative flex justify-center items-center group perspective-1000">
            {/* Decorative glow */}
            <div className="absolute w-[300px] h-[300px] bg-[#b91c1c]/10 rounded-full blur-[100px] group-hover:bg-[#b91c1c]/20 transition-all duration-700"></div>
            ...
            <div className="relative w-72 h-80 bg-gradient-to-br from-white/5 to-black border border-white/10 rounded-sm shadow-[0_20px_60px_rgba(0,0,0,0.8)] flex items-center justify-center overflow-hidden transform transition-all duration-700 group-hover:rotate-y-12 group-hover:scale-105">
              ...
              <div className="flex flex-col items-center opacity-40 group-hover:opacity-100 transition-opacity duration-700">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#b91c1c]">Top Secret</span>
              </div>
            </div>
            ...
            <div className="absolute bottom-12 -left-4 bg-black/60 backdrop-blur-md border border-[#b91c1c]/30 px-4 py-2 text-[8px] font-black uppercase tracking-[0.3em] text-[#b91c1c] rounded-sm shadow-xl transform -translate-x-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 delay-200">
              Calidad Premium
            </div>
          </div>
