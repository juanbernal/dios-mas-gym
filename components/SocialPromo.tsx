...
export const InlineSocialBanner: React.FC = () => {
    return (
        <div className="bg-[#0f111a] border border-[#4a90d9]/20 rounded-3xl p-8 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 w-full max-w-4xl mx-auto my-16 shadow-2xl">
