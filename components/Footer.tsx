  ...
  return (
    <footer className="py-32 bg-[#05070a] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="section-container relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 text-[10px] font-black tracking-[0.6em] text-[#2563a8] uppercase opacity-60 mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 w-full max-w-4xl text-center md:text-left mb-20 border-y border-white/5 py-16">
          <div>
            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#2563a8] mb-6">Misión</h4>
            <p className="text-white/40 text-xs leading-relaxed font-medium">
              Fortaleciendo el cuerpo y el espíritu a través de la fe y la disciplina diaria.
            </p>
          </div>
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#2563a8] mb-6">Música</h4>
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-[#2563a8] mb-6">Link Bio</h4>
            <div className="flex flex-col gap-3 text-white/40 text-xs font-bold font-black tracking-widest uppercase">
        ...
        <div className="text-center">
          <div className="h-px w-24 bg-gradient-to-r from-transparent via-[#2563a8]/40 to-transparent mx-auto mb-10"></div>
